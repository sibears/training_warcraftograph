...
PORT = 8084
DB_FILE = "./sexy_cows_storage.db"
# don't forget to change it, my Lord
WARCHIEF_SECRET = "HOOFSAREGOOD"
EXCUSES = [
    "Sorry, our murlocs can't find your secret! Are your sure that it was stored?",
...
def get_secret_by_id(id):
    ...
    return render_template(
        "secret.html", secrets=[(secret_name, fname)], cssclass=cssclass
    )
...
def api_get_secret():
    ...
    try:
        ...
        return json.dumps({"result": "error", "message": "Wrong arguments"})
    ...
    return json.dumps({"result": "error", "message": "No such secret"})
