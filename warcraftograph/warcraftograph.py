...
word_index = {'0': '_phys_1.jpg', '1': '_class_2.jpg', '2': '_class_2b.jpg', '3': '_resist_4.jpg', '4': '_class_3a.jpg',
              '5': '_feral_4a.jpg', '6': '_feral_5.jpg', '7': '_feral_6.jpg', '8': '_hand_1.jpg', '9': '_hand_5.jpg',
              'a': '_nature_4.jpg', 'b': '_nature_6.jpg', 'c': '_nature_7.jpg', 'd': '_orb_1.jpg', 'e': '_orb_4.jpg',
              'f': '_feral_2.jpg'}
second_list = ["_animal_1.jpg", "_class_2a.jpg", "_class_3b.jpg", "_feral_1.jpg", "_feral_3.jpg", "_feral_4b.jpg",
               "_nature_1.jpg", "_nature_2.jpg", "_nature_5.jpg", "_nature_8.jpg"]
    ...
    for i in range(0, max_count):
        ...
        for path, code in decode_index.items():
            ...
            for l in range(0, image_for_compare.size[0]):
                if ((current_im[l, l][0] == im_for_compare[l, l][0]) or (
                        current_im[l, l][1] == im_for_compare[l, l][1]) or (
                        current_im[l, l][2] == im_for_compare[l, l][2])):
